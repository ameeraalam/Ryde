    ...
    return (
      ...
      <Container>
        ...
        <Tabs initialPage={0} tabBarPosition='bottom' >
          <Tab heading={ <TabHeading style={{backgroundColor: 'rgb(0, 51, 153)'}}><Icon active name="checkmark-circle"/><Text style={{color:'white', fontSize: 16, fontFamily: 'sans-serif', marginLeft: 10}}>Available</Text></TabHeading>}>
            <Available resObj={resObj} />
          </Tab>
          <Tab heading={ <TabHeading style={{backgroundColor: 'rgb(0, 51, 153)'}}><Icon active name="time" /><Text style={{color:'white', fontSize: 16, fontFamily: 'sans-serif', marginLeft: 10}}>Pending</Text></TabHeading>}>
